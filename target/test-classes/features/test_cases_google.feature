@tag
Feature: Sahi page object test with Google Chrome
  I want to test each of the objects on the SAHI page as a technical test.
  
  @links
  Scenario: Links
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/linkTest.htm"
 ...
 @selects
 Scenario: Selects
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/selectTest.htm"
...
@iframes
Scenario: iframes
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/iframesTest.htm"
...
@clicks
Scenario: clicks
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/clicks.htm"
...
@alerts
Scenario: Alerts
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/confirmTest.htm"
...
Scenario: Alerts with text
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/promptTest.htm"
    When I want search button and Click For Prompt
    And I close browser

@new_tab
Scenario: new tab
    Given I use Google Chrome and I want to enter the page sahi link "http://sahitest.com/demo/index.htm"
